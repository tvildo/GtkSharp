...
namespace Gst {
	...
	public partial class Iterator : IEnumerable {
		...
		static d_gst_iterator_next gst_iterator_next = FuncLoader.LoadFunction<d_gst_iterator_next>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gstreamer), "gst_iterator_next"));
