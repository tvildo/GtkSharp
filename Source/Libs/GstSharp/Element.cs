...
namespace Gst {
	...
	partial class Element 
	{
		...
		static d_gst_element_class_add_metadata gst_element_class_add_metadata = FuncLoader.LoadFunction<d_gst_element_class_add_metadata>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gstreamer), "gst_element_class_add_metadata"));
		...
		static d_gst_element_class_add_pad_template gst_element_class_add_pad_template = FuncLoader.LoadFunction<d_gst_element_class_add_pad_template>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gstreamer), "gst_element_class_add_pad_template"));
		...
		static d_gst_element_class_add_static_metadata gst_element_class_add_static_metadata = FuncLoader.LoadFunction<d_gst_element_class_add_static_metadata>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gstreamer), "gst_element_class_add_static_metadata"));
		...
		static d_gst_element_class_set_metadata gst_element_class_set_metadata = FuncLoader.LoadFunction<d_gst_element_class_set_metadata>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gstreamer), "gst_element_class_set_metadata"));
		...
		static d_gst_element_class_set_static_metadata gst_element_class_set_static_metadata = FuncLoader.LoadFunction<d_gst_element_class_set_static_metadata>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gstreamer), "gst_element_class_set_static_metadata"));
