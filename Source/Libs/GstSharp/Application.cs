...
namespace Gst {
	...
	partial class Application 
	{
		...
		delegate void d_gst_init(ref int argc, ref IntPtr[] argv);
		static d_gst_init gst_init = FuncLoader.LoadFunction<d_gst_init>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gstreamer), "gst_init"));

		//[DllImport("gstreamer-1.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		//static extern void gst_init(IntPtr argc, IntPtr argv);

		delegate void d_gst_init2(IntPtr argc, IntPtr argv);
		static d_gst_init2 gst_init2 = FuncLoader.LoadFunction<d_gst_init2>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gstreamer), "gst_init"));
		...
		public static void Init() {
			gst_init2(IntPtr.Zero, IntPtr.Zero);
			CheckVersion();
		}
		...
		delegate bool d_gst_init_check(ref int argc, ref IntPtr[] argv, out IntPtr error);
		static d_gst_init_check gst_init_check = FuncLoader.LoadFunction<d_gst_init_check>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gstreamer), "gst_init_check"));

		//[DllImport("gstreamer-1.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		//static extern bool gst_init_check(IntPtr argc, IntPtr argv, out IntPtr error);

		delegate bool d_gst_init_check2(IntPtr argc, IntPtr argv, out IntPtr error);
		static d_gst_init_check2 gst_init_check2 = FuncLoader.LoadFunction<d_gst_init_check2>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gstreamer), "gst_init_check"));

		public static bool InitCheck() {
			IntPtr error = IntPtr.Zero;
			bool ret = gst_init_check2(IntPtr.Zero, IntPtr.Zero, out error);
