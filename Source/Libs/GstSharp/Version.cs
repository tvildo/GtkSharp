...
namespace Gst
{
	public static class Version
	{
		...
		static d_gst_version gst_version = FuncLoader.LoadFunction<d_gst_version>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gstreamer), "gst_version"));

		//[DllImport ("gstreamer-1.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		//private static extern IntPtr gst_version_string ();

		delegate IntPtr d_gst_version_string();
		static d_gst_version_string gst_version_string = FuncLoader.LoadFunction<d_gst_version_string>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gstreamer), "gst_version_string"));
	}
}
