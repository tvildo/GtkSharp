...
namespace Gst {
	...
	partial class DeviceProvider 
	{
		...
		static d_gst_device_provider_class_add_metadata gst_device_provider_class_add_metadata = FuncLoader.LoadFunction<d_gst_device_provider_class_add_metadata>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gstreamer), "gst_device_provider_class_add_metadata"));
		...
		static d_gst_device_provider_class_add_static_metadata gst_device_provider_class_add_static_metadata = FuncLoader.LoadFunction<d_gst_device_provider_class_add_static_metadata>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gstreamer), "gst_device_provider_class_add_static_metadata"));
		...
		static d_gst_device_provider_class_set_metadata gst_device_provider_class_set_metadata = FuncLoader.LoadFunction<d_gst_device_provider_class_set_metadata>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gstreamer), "gst_device_provider_class_set_metadata"));
		...
		static d_gst_device_provider_class_set_static_metadata gst_device_provider_class_set_static_metadata = FuncLoader.LoadFunction<d_gst_device_provider_class_set_static_metadata>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gstreamer), "gst_device_provider_class_set_static_metadata"));
