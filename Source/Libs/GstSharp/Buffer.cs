...
namespace Gst {
	...
	partial class Buffer {
		...
		static d_gst_buffer_extract gst_buffer_extract = FuncLoader.LoadFunction<d_gst_buffer_extract>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gstreamer), "gst_buffer_extract"));
		...
		delegate UIntPtr d_gst_buffer_extract_dup(IntPtr raw, UIntPtr offset, UIntPtr size, out IntPtr dest, out UIntPtr dest_size);
		static d_gst_buffer_extract_dup gst_buffer_extract_dup = FuncLoader.LoadFunction<d_gst_buffer_extract_dup>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gstreamer), "gst_buffer_extract_dup"));
		...
		static d_gst_buffer_new_wrapped gst_buffer_new_wrapped = FuncLoader.LoadFunction<d_gst_buffer_new_wrapped>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gstreamer), "gst_buffer_new_wrapped"));
